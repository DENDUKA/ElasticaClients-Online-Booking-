...
namespace ElasticaClients.Models
{
    public class AccountModel : IValidatableObject
    {
        ...
        internal static bool LoginSuccess(AccountB accountB, string phone, string password)
        {
        ...
        internal static bool LoginSuccessByPhone(AccountB accountB, string phone)
        {
            var acc = accountB.GetByPhone(phone);
        ...
        public static IEnumerable<SelectListItem> ClientsToSelectListItems(AccountB accountB, List<Account> accs = null)
        {
            if (accs is null)
            {
                accs = accountB.GetAll();
            }
        ...
        public static IEnumerable<SelectListItem> TrainersToSelectListItems(AccountB accountB, int selectedId = 0, List<Account> accs = null)
        {
            if (accs is null)
            {
                accs = accountB.GetAll();
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (Id == 0)
            {
                var accountB = System.Web.Mvc.DependencyResolver.Current.GetService(typeof(AccountB)) as AccountB;
                var acc = accountB?.GetByPhone(Phone);
