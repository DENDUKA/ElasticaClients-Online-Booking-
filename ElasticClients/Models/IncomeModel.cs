...
namespace ElasticaClients.Models
{
	public class IncomeModel
	{
		...
		internal static List<IncomeModel> GetList(int gymId, DateTime? start, DateTime? end)
		{
			...
			var list = IncomeDAL.GetAll(gymId, st, en);
			...
			var subs = SubscriptionDAL.GetAll(start, end);
		...
		public static IncomeModel Get(int id)
		{
